...
# Modified : Wednesday, January 26th 2022, 9:20:19 pm                                                                      #
...
class OutlierTests:
    def __init__(self):
        filepath = "tests\\data\staged\criteo.csv"
    ...
    def test_zscore(self):
        ...
        assert isinstance(labels, (list, np.ndarray)), logger.error("Failure in {}.".format(inspect.stack()[0][3]))
    ...
    def test_outliers(self):
        ...
        print("Summary of outlier analysis \n\n{}.".format(self._o.results_["ensemble"]["summary"]))
