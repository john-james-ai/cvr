...
# Modified : Friday, January 21st 2022, 12:35:26 am                                                                        #
...
from cvr.core.task import Download, Decompress, Copy, LoadTSV, SetNA, SavePKLDataFrame
...
class ETLTests:
    ...
    def test_tasks(self):
        ...
        self._decompress = Decompress(
            source=self._config.filepath_compressed, destination=self._config.filepath_decompressed
        )
        self._copy = Copy(source=self._config.filepath_decompressed, destination=self._config.filepath_raw)
        self._load = LoadTSV(source=self._config.filepath_raw)
